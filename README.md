...
- 🎓 Graduated with a bachelor's degree in Computer Science, studying a master's degree in cybersecurity in Belgium
- 🦀 Interested in IT, cybersecurity, web development, and programming in general
...
### 🖼️ **svg-to-drawio**
Cross-platform desktop application, a Python library (API), and a command-line interface for converting SVG files into a format importable by draw.io (diagrams.net). It transforms SVG diagrams or illustrations into files ready to import into draw.io, facilitating migration of vector graphics into editable diagrams.

🔗 [GitHub Repository](https://github.com/V1rg1lee/svg-to-drawio)
